...
unsigned long minOn = 2;    // Sets fixed 2 minute on time **
unsigned long minOff = 28;  // Sets fixed 28 minute off time **
...
void setup()
{
 ...
 int previousUnixTime = unixTime;

  delay(500); // allow time for serial output to settle
...
// not tested to see if this works - fixed to 60 minutes 2/9/23
